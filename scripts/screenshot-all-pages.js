...
async function takeAllPagesScreenshots() {
  ...
  // 各ページのURLと名前
  const pages = [
    { url: 'http://localhost:5173/', name: 'library-search', title: '図書館検索ページ' },
    { url: 'http://localhost:5173/map', name: 'map-page', title: '地図表示ページ' },
    { url: 'http://localhost:5173/books', name: 'book-search', title: '蔵書検索ページ' }
  ];
